...
namespace rsl
{
	...
	constexpr size_type find_first_of([[maybe_unused]] array_view<const T, Iter> str,
	                                  [[maybe_unused]] array_view<const T, Iter> key, [[maybe_unused]] size_type pos) noexcept
	{
	...
	template <typename T, contiguous_iterator Iter>
	constexpr size_type find_first_not_of([[maybe_unused]] array_view<const T, Iter> str,
	                                      [[maybe_unused]] array_view<const T, Iter> key,
	                                      [[maybe_unused]] size_type pos) noexcept
	{
		rsl_assert_unimplemented();
		return 0;
	...
	template <typename T, contiguous_iterator Iter>
	constexpr size_type find_last_of([[maybe_unused]] array_view<const T, Iter> str, [[maybe_unused]] array_view<const T, Iter> key,
	                                 [[maybe_unused]] size_type pos) noexcept
	{
		rsl_assert_unimplemented();
		return 0;
	...
	template <typename T, contiguous_iterator Iter>
	constexpr size_type find_last_not_of([[maybe_unused]] array_view<const T, Iter> str,
	                                     [[maybe_unused]] array_view<const T, Iter> key,
	                                     [[maybe_unused]] size_type pos) noexcept
	{
		rsl_assert_unimplemented();
	...
	template <typename T, contiguous_iterator Iter>
	constexpr size_type find_first_of([[maybe_unused]] array_view<const T, Iter> str, [[maybe_unused]] const T& key,
	                                  [[maybe_unused]] size_type pos) noexcept
	{
		rsl_assert_unimplemented();
		return 0;
