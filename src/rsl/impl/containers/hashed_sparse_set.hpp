...
namespace rsl
{
    ...
    public:
         ...
         */
        R_NODISCARD size_type size() const noexcept { return m_size; }
         ...
         */
        R_NODISCARD size_type capacity() const noexcept { return m_capacity; }
         ...
         * @returns size_type
         */
        R_NODISCARD size_type max_size() const noexcept { return m_dense.max_size(); }
...
#pragma region count
         ...
         */
        R_NODISCARD size_type count(value_const_reference val) const
        {
            return contains(val);
        }
         ...
         * @ref legion::core::sparse_map::contains
         */
        R_NODISCARD size_type count(value_type&& val) const
        {
            return contains(val);
        }
#pragma endregion
...
#pragma region operator[]
         ...
         */
        R_NODISCARD value_reference operator[](size_type&& index)
        {
         ...
         * @param index Index of item in dense container.
         */
        R_NODISCARD value_reference operator[](const size_type& index)
        {
            if (index < 0 || index > m_size)
                throw std::out_of_range("hashed_sparse_set subscript out of range");
            return m_dense[index];
         ...
         * @param index Index of item in dense container.
         */
        R_NODISCARD value_const_reference operator[](size_type&& index) const
        {
            if (index < 0 || index > m_size)
                throw std::out_of_range("hashed_sparse_set subscript out of range");
            return m_dense[index];
         ...
         * @param index Index of item in dense container.
         */
        R_NODISCARD value_const_reference operator[](const size_type& index) const
        {
            if (index < 0 || index > m_size)
                throw std::out_of_range("hashed_sparse_set subscript out of range");
            return m_dense[index];
...
#pragma region at
         ...
         * @param index Index of item in dense container.
         */
        R_NODISCARD value_reference at(size_type&& index)
        {
            if (index < 0 || index > m_size)
                throw std::out_of_range("hashed_sparse_set subscript out of range");
            return m_dense[index];
         ...
         * @param index Index of item in dense container.
         */
        R_NODISCARD value_reference at(const size_type& index)
        {
            if (index < 0 || index > m_size)
                throw std::out_of_range("hashed_sparse_set subscript out of range");
            return m_dense[index];
         ...
         * @param index Index of item in dense container.
         */
        R_NODISCARD value_const_reference at(size_type&& index) const
        {
            if (index < 0 || index > m_size)
                throw std::out_of_range("hashed_sparse_set subscript out of range");
            return m_dense[index];
         ...
         * @param index Index of item in dense container.
         */
        R_NODISCARD value_const_reference at(const size_type& index) const
        {
            if (index < 0 || index > m_size)
                throw std::out_of_range("hashed_sparse_set subscript out of range");
            return m_dense[index];
