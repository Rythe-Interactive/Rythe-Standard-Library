...
namespace rsl
{
    ...
    public:
        ...
        template <class ValueType, std::enable_if_t<std::conjunction_v<std::negation<std::is_same<std::decay_t<ValueType>, any>>,
        ...
        template <class ValueType, class... Types,
            std::enable_if_t<std::conjunction_v<std::is_constructible<std::decay_t<ValueType>, Types...>, std::is_copy_constructible<std::decay_t<ValueType>>>, int> = 0>
        ...
        template <class ValueType, class Elem, class... Types,
            std::enable_if_t<std::conjunction_v<std::is_constructible<std::decay_t<ValueType>, std::initializer_list<Elem>&, Types...>,
            std::is_copy_constructible<std::decay_t<ValueType>>>,
            int> = 0>
        ...
        template <class ValueType, class Elem, class... Types,
            std::enable_if_t<std::conjunction_v<std::is_constructible<std::decay_t<ValueType>, std::initializer_list<Elem>&, Types...>, std::is_copy_constructible<std::decay_t<ValueType>>>, int> = 0>
    ...
    template <class ValueType, class... Types,
        std::enable_if_t<std::is_constructible_v<any<sizeof(ValueType)>, std::in_place_type_t<ValueType>, Types...>, int> = 0>
    ...
    template <class ValueType, class Elem, class... Types,
        std::enable_if_t<std::is_constructible_v<any<sizeof(ValueType)>, std::in_place_type_t<ValueType>, std::initializer_list<Elem>&, Types...>, int> = 0>
    ...
    [[nodiscard]] std::remove_cv_t<Ty> any_cast(const any<sizeof(Ty)>& Any) {
        static_assert(std::is_constructible_v<std::remove_cv_t<Ty>, const std::remove_cvref_t<Ty>&>,
    ...
    [[nodiscard]] std::remove_cv_t<Ty> any_cast(any<sizeof(Ty)>& Any) {
        static_assert(std::is_constructible_v<std::remove_cv_t<Ty>, std::remove_cvref_t<Ty>&>,
