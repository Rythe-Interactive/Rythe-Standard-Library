...
namespace rsl
{
	namespace enum_flags
	{
		...
		constexpr Enum combine_flags(Enum first, Enum second, T... rest);
		...
		template <enum_type T>
		constexpr bool has_all_flags(T value, T flag)
		{
			using BaseType = std::underlying_type_t<T>;
		...
		constexpr bool has_any_flags(Enum value, Enum first, Enum second, T... rest)
		{
		...
		template <enum_type T>
		constexpr T invert_flag(T flag)
		{
			using BaseType = std::underlying_type_t<T>;
		...
		template <enum_type Enum, std::same_as<Enum>... T>
		constexpr Enum unflag(Enum value, Enum first, T... rest)
		{
			using BaseType = std::underlying_type_t<Enum>;
		...
		template <enum_type Enum, std::same_as<Enum>... T>
		constexpr Enum exclude_flags(Enum first, Enum second, T... rest)
		{
			using BaseType = std::underlying_type_t<Enum>;
			return static_cast<Enum>(
				static_cast<BaseType>(first) & (static_cast<BaseType>(rest) & ... & static_cast<BaseType>(second))
		...
		template <enum_type Enum, std::same_as<Enum>... T>
		constexpr Enum toggle_flags(Enum first, Enum second, T... rest)
		{
			using BaseType = std::underlying_type_t<Enum>;
			return static_cast<Enum>(
