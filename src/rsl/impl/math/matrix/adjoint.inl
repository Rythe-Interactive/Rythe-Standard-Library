...
namespace rsl::math
{
    namespace detail
    {
        ...
        struct compute_adjoint<matrix<Scalar, RowCount, ColCount>>
        {
            ...
            [[nodiscard]] always_inline constexpr static auto compute(const mat_type& v) noexcept
            {
    ...
    [[nodiscard]] always_inline constexpr auto adjoint(const mat_type& mat) noexcept
    {
