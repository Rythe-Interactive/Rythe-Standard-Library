...
namespace rsl::math
{
    namespace detail
    {
        ...
        [[nodiscard]] always_inline constexpr auto extract_sub_mat(const mat_type& v, size_type rowIdx, size_type colIdx)
        {
        ...
        struct compute_determinant<matrix<Scalar, RowCount, ColCount>>
        {
            ...
            [[nodiscard]] always_inline constexpr static Scalar compute(const mat_type& v) noexcept
            {
    ...
    [[nodiscard]] always_inline constexpr auto determinant(const mat_type& mat) noexcept
    {
