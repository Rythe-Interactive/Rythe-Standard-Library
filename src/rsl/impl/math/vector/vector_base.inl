...
namespace rsl::math
{
	...
	template <typename Scalar, size_type Size>
	constexpr vector<Scalar, Size>::vector() noexcept
	{
		for (size_type i = 0; i < size; i++) data[i] = static_cast<scalar>(0);
	}

	template <typename Scalar, size_type Size>
	constexpr vector<Scalar, Size>::vector(scalar s) noexcept
	{
		for (size_type i = 0; i < size; i++) data[i] = s;
	}
...
struct ::std::tuple_element<I, ::rsl::math::vector<Scalar, Size>>
{
	using type = Scalar;
};
...
struct ::std::tuple_size<::rsl::math::vector<Scalar, Size>> : public std::integral_constant<::std::size_t, Size>
{
};

template <typename Scalar, ::std::size_t Size>
struct ::std::tuple_size<const ::rsl::math::vector<Scalar, Size>> : public std::integral_constant<::std::size_t, Size>
{
};

template <typename Scalar, ::std::size_t Size>
struct ::std::tuple_size<volatile ::rsl::math::vector<Scalar, Size>> : public std::integral_constant<::std::size_t, Size>
{
};

template <typename Scalar, ::std::size_t Size>
struct ::std::tuple_size<const volatile ::rsl::math::vector<Scalar, Size>> : public std::integral_constant<::std::size_t, Size>
{
};
