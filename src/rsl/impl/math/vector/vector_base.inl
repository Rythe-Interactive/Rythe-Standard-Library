...
namespace rsl::math
{
    ...
    template<typename Scalar, size_type Size>
    [[nodiscard]] rythe_always_inline Scalar vector<Scalar, Size>::length() const noexcept { return ::rsl::math::length(*this); }
    ...
    inline rythe_always_inline Scalar& get(vector<Scalar, Size>& val) { return val[I]; }
}
...
{
    template<::std::size_t I, typename Scalar, ::std::size_t Size>
    inline rythe_always_inline Scalar& get(::rsl::math::vector<Scalar, Size>& val) { return ::rsl::math::get<I>(val); }
}
