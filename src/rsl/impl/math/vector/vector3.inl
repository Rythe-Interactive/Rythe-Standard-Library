...
namespace rsl::math
{
    ...
    inline rythe_always_inline constexpr vector<Scalar, 3>::vector(const vector<scalar, 2>& v, scalar s) noexcept : vector(v.x, v.y, s) {}

    template<typename Scalar>
    inline rythe_always_inline constexpr vector<Scalar, 3>::vector(scalar s, const vector<scalar, 2>& v) noexcept : vector(s, v.x, v.y) {}

    template<typename Scalar>
    inline rythe_always_inline constexpr vector<Scalar, 3>::vector(scalar _x, scalar _y, scalar _z) noexcept : x(_x), y(_y), z(_z) {}
