...
namespace rsl::math::noise
{
    namespace detail
    {
        ...
        [[nodiscard]] always_inline constexpr scalar _value_1d_impl_(int_scalar seed, scalar value) noexcept
        {
        ...
        template<typename scalar, typename int_scalar = int_least<sizeof(scalar)>>
        [[nodiscard]] always_inline constexpr scalar _value_1d_impl_(int_scalar seed, scalar value, scalar& derivative) noexcept
        {
            int_scalar floored = ifloor<int_scalar>(value);
            int_scalar start = floored * primes<int_scalar>.x;
        ...
        [[nodiscard]] always_inline constexpr scalar _value_2d_impl_(int_scalar seed, VectorType value) noexcept
        {
        ...
        template<typename scalar, typename int_scalar = int_least<sizeof(scalar)>, typename VectorType>
        [[nodiscard]] always_inline constexpr scalar _value_2d_impl_(int_scalar seed, VectorType value, vector<scalar, 2>& derivative) noexcept
        {
            using scalar2 = vector<scalar, 2>;
            using int_scalar2 = vector<int_scalar, 2>;
        ...
        template<typename scalar, typename int_scalar = int_least<sizeof(scalar)>, typename VectorType>
        [[nodiscard]] always_inline constexpr scalar _value_3d_impl_(int_scalar seed, VectorType value) noexcept
        {
        ...
        template<typename scalar, typename int_scalar = int_least<sizeof(scalar)>, typename VectorType>
        [[nodiscard]] always_inline constexpr scalar _value_3d_impl_(int_scalar seed, VectorType value, vector<scalar, 3>& derivative) noexcept
        {
            using scalar2 = vector<scalar, 2>;
            using scalar3 = vector<scalar, 3>;
    ...
    [[nodiscard]] always_inline constexpr auto value(VectorType&& value, int_least<sizeof(vector_scalar_t<VectorType>)> seed) noexcept
    {
    ...
    template<typename VectorType>
    [[nodiscard]] always_inline constexpr auto value(VectorType&& value, decay_vector_t<VectorType>& derivative, int_least<sizeof(vector_scalar_t<VectorType>)> seed) noexcept
    {
        constexpr size_type dimensions = vector_size_v<VectorType>;
        using scalar = vector_scalar_t<VectorType>;
