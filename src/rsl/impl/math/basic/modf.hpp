...
namespace rsl::math
{
    namespace detail
    {
        ...
        struct compute_modf
        {
            ...
            inline always_inline static value_type compute(const value_type& val, value_type& integer) noexcept
            {
                    value_type result;
        ...
        struct compute_modf<Scalar, 1u>
        {
            ...
            inline always_inline static value_type compute(Scalar val, RET& integer) noexcept
            {
    ...
    inline always_inline static auto modf(const T& val, RET& integer)
    {
