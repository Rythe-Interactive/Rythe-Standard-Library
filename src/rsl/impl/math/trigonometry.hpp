...
#pragma endregion
	...
	public:
		 ...
		 */
		[[nodiscard]] constexpr storage_type as_degrees() const;

		/**@brief Converts an angle to radians
		 */
		[[nodiscard]] constexpr storage_type as_radians() const;
	...
	using anglef = angle<>;
	using angled = angle<float64>;
	using angleld = angle<float_max>;
