...
{
    template<typename T>
    [[nodiscard]] always_inline constexpr auto _quintic_impl_(T&& v) noexcept
    {
    ...
    template<typename T>
    [[nodiscard]] always_inline constexpr auto _quintic_derivative_impl_(T&& v) noexcept
    {
        using scalar = ::std::remove_cvref_t<T>;
    ...
    template<typename T>
    [[nodiscard]] always_inline auto _inverse_quintic_impl_(T&& v) noexcept
    {
        using scalar = ::std::remove_cvref_t<T>;
    ...
    template<typename T>
    [[nodiscard]] always_inline constexpr auto _inverse_quintic_derivative_impl_(T&& v) noexcept
    {
        using scalar = ::std::remove_cvref_t<T>;
