...
{
    template<typename T>
    [[nodiscard]] always_inline constexpr auto _smoothstep_impl_(T&& v) noexcept
    {
    ...
    template<typename T>
    [[nodiscard]] always_inline constexpr auto _smoothstep_derivative_impl_(T&& v) noexcept
    {
        using scalar = ::std::remove_cvref_t<T>;
    ...
    template<typename T>
    [[nodiscard]] always_inline auto _inverse_smoothstep_impl_(T&& v) noexcept
    {
        using scalar = ::std::remove_cvref_t<T>;
    ...
    template<typename T>
    [[nodiscard]] always_inline auto _inverse_smoothstep_derivative_impl_(T&& v) noexcept
    {
        using scalar = ::std::remove_cvref_t<T>;
...
namespace rsl::math
{
    ...
    [[nodiscard]] always_inline constexpr auto smoothstep(TypeMin&& edgeMin, TypeMax&& edgeMax, ValueType&& value) noexcept
    {
    ...
    [[nodiscard]] always_inline constexpr auto smoothstep(ValueType&& value) noexcept
    {
        using T = ::std::remove_cvref_t<ValueType>;
    ...
    template<typename TypeMin, typename TypeMax, typename ValueType>
    [[nodiscard]] always_inline constexpr auto smoothstep_derivative(TypeMin&& edgeMin, TypeMax&& edgeMax, ValueType&& value) noexcept
    {
        using A = ::std::remove_cvref_t<TypeMin>;
        using B = ::std::remove_cvref_t<TypeMax>;
        using T = ::std::remove_cvref_t<ValueType>;
    ...
    // smoothstep_derivative
    template<typename ValueType>
    [[nodiscard]] always_inline constexpr auto smoothstep_derivative(ValueType&& value) noexcept
    {
        using T = ::std::remove_cvref_t<ValueType>;
    ...
    // inverse_smoothstep
    template<typename TypeMin, typename TypeMax, typename ValueType>
    [[nodiscard]] always_inline auto inverse_smoothstep(TypeMin&& edgeMin, TypeMax&& edgeMax, ValueType&& value) noexcept
    {
        using A = ::std::remove_cvref_t<TypeMin>;
        using B = ::std::remove_cvref_t<TypeMax>;
        using T = ::std::remove_cvref_t<ValueType>;
    ...
    // inverse_smoothstep
    template<typename ValueType>
    [[nodiscard]] always_inline auto inverse_smoothstep(ValueType&& value) noexcept
    {
        using T = ::std::remove_cvref_t<ValueType>;
    ...
    template<typename TypeMin, typename TypeMax, typename ValueType>
    [[nodiscard]] always_inline auto inverse_smoothstep_derivative(TypeMin&& edgeMin, TypeMax&& edgeMax, ValueType&& value) noexcept
    {
        using A = ::std::remove_cvref_t<TypeMin>;
        using B = ::std::remove_cvref_t<TypeMax>;
        using T = ::std::remove_cvref_t<ValueType>;
    ...
    // inverse_smoothstep_derivative
    template<typename ValueType>
    [[nodiscard]] always_inline auto inverse_smoothstep_derivative(ValueType&& value) noexcept
    {
        using T = ::std::remove_cvref_t<ValueType>;
