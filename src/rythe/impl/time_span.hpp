...
L_NODISCARD constexpr rsl::time_span<std::common_type_t<PrecisionType1, PrecisionType2>>
operator+(const rsl::time_span<PrecisionType1>& lhs, const rsl::time_span<PrecisionType2>& rhs)
noexcept(std::is_arithmetic_v<PrecisionType1>&& std::is_arithmetic_v<PrecisionType2>) /* strengthened */
{
    using common_span = rsl::time_span<std::common_type_t<PrecisionType1, PrecisionType2>>;
